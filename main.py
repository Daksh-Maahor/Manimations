...
class Graphing(Scene):
    def construct(self):
        ...
        my_function = my_plane.plot(lambda x : 0.1 * x * (x-5) * (x+5), x_range=[-6, 6], color=GREEN_B)
        ...
        horiz_line = Line(start=my_plane.c2p(0, my_function.function(-2)), end=my_plane.c2p(-2, my_function.function(-2)), stroke_color=YELLOW, stroke_width=10)
